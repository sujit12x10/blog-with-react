...
export const PostCard = ({$id, slug, title, content, featuredImage, date}) => {
    ...
    return (
        <div className="rounded overflow-hidden shadow-lg flex flex-col">
                ...
                <div className="px-6 py-4 mb-auto">
                    <span href="#"
                        className="cursor-pointer font-medium text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out mb-2 truncate">
                            {title}
                        </span>
